...
class InternVL2Model(VLMBase):
    def __init__(self, model_id="OpenGVLab/InternVL2-26B"):
        super().__init__("InternVL2-26B")
    ...
    def predict(self, image, question, options=None, **kwargs):
        # InternVL2 has slightly different processing or same as 1.5 depending on updates
        # Assuming similar chat interface
